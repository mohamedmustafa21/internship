    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <table class="table table-striped table-bordered" style="max-height: 800px; overflow-y: auto;">
                ...
                <tbody> 
                    <?php $__currentLoopData = $all_feedbacks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $all_feedback): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><?php echo e($all_feedback->supervisor_full_name); ?></td>
                            <td><?php echo e($all_feedback->intern_full_name); ?></td>
                            <td><?php echo e($all_feedback->training_industry); ?></td>
                            <td><?php echo e($all_feedback -> training_field); ?></td>
                            <td><?php echo e($all_feedback -> training_round); ?></td>
                            <td><?php echo e($all_feedback -> considered_other_people); ?></td>
                            <td><?php echo e($all_feedback -> receptive); ?></td>
                            <td><?php echo e($all_feedback -> punctual_and_dependable); ?></td>
                            <td><?php echo e($all_feedback -> demonstrated_completed_tasks); ?></td>
                            <td><?php echo e($all_feedback -> quality_of_completed_tasks); ?></td>
                            <td><?php echo e($all_feedback -> able_to_learn); ?></td>
                            <td><?php echo e($all_feedback -> critical_thinking); ?></td>
                            <td><?php echo e($all_feedback -> academically_prepared); ?></td>
                            <td><?php echo e($all_feedback -> intern_strengths); ?></td>
                            <td><?php echo e($all_feedback -> intern_weaknesses); ?></td>
                            <td><?php echo e($all_feedback -> hire_intern); ?></td>
...
<?php echo $__env->make('layouts.adminlayouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/zhufapmy/public_html/internships/internshipPortal/resources/views/mentoruserfeedback.blade.php ENDPATH**/ ?>