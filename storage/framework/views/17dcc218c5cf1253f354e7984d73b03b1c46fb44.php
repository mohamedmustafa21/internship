...
<style>
    @font-face {
        ...
        src: url('<?php echo e(asset("assets/fonts/HolidayFree.otf")); ?>') format('opentype');
        font-weight: normal;
        font-style: normal;
    }
...
<div class="container my-5">
    <div class="row">
        <div class="col-md-4">
            <img src="<?php echo e(asset('assets/imgs/whoweare.png')); ?>" width="100%" alt="Image">
        </div>
        <div class="col-md-8">
            <div class="content" id="whoweare">
                <h1 class="text-center mb-4">
                    <img src="<?php echo e(asset('assets/imgs/icon.png')); ?>" height="35" alt="">
                    Who We Are
                </h1>
                <p>
        ...
        <div class="col-12 p-4">
             <div class="col-12 text-center p-2" style="background-color: #19176c">
                    <img src="<?php echo e(asset('assets/imgs/logos/00.png')); ?>" alt="Image">
                </div>
        ...
        <div class="col-12">
            ...
            <div class="row">
                <div class="col-md-5">
                    <img src="<?php echo e(asset('assets/imgs/02.png')); ?>" alt="">
                </div>
                <div class="col-md-7">
                    ...
                    <div class="row ">
                        <?php for($x=1;$x<5;$x++): ?>
                            <div class="col-sm-6 col-lg-3 text-center pt-3 ">
                                <img src="<?php echo e(asset('assets/imgs/ProgramPurposeIcons0'.$x.'.png')); ?>" height="75" alt="Image">
                            </div>
                        <?php endfor; ?>
                    </div>
                </div>
...
<div class="col-12 d-block d-md-none text-center p-2 " style=" border-radius: 15px;">
    <div class="row" style="padding: 15px;">
        <div class="col-6 text-start d-flex align-items-center mb-3" style="background-color: #19176c; padding: 15px;">
            <img src="<?php echo e(asset('assets/imgs/ProgramPurposeIcons01.png')); ?>" height="30" class="me-2" alt="Icon">
            <span class="text-white">Industrial Sector</span>
        </div>
        <div class="col-6 text-start d-flex align-items-center mb-3" style="background-color: #19176c; padding: 15px;">
            <img src="<?php echo e(asset('assets/imgs/ProgramPurposeIcons02.png')); ?>" height="30" class="me-2" alt="Icon">
            <span class="text-white">Building Materials Sector</span>
        </div>
        <div class="col-6 text-start d-flex align-items-center mb-3" style="background-color: #19176c; padding: 15px;">
            <img src="<?php echo e(asset('assets/imgs/ProgramPurposeIcons03.png')); ?>" height="30" class="me-2" alt="Icon">
            <span class="text-white">Real Estate Sector</span>
        </div>
        <div class="col-6 text-start d-flex align-items-center mb-3" style="background-color: #19176c; padding: 15px;">
            <img src="<?php echo e(asset('assets/imgs/ProgramPurposeIcons04.png')); ?>" height="30" class="me-2" alt="Icon">
        ...
        <div class="row mt-5">
            <div class="col-md-5">
                <img src="<?php echo e(asset('assets/imgs/01.png')); ?>" class="img-fluid" alt="">
            </div>
            <div class="col-md-6">
...
Each applicant should choose one of the two streams in the following industries. Depending on his/her choice, the intern will be assigned to mentors accordingly.</p>
    ...
    background-image: url('<?php echo e(asset('assets/imgs/Coverrr.JPG')); ?>');
    background-size: cover;
...
<?php $__currentLoopData = $industries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $industry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="col-md-<?php echo e($industry['wide'] ?? false ? '8' : '4'); ?> mb-3">
        <div class="home-article pb-3" style="background-color: #252e62 ; border-radius: 10px; color: white;">
            <img src="<?php echo e(asset('assets/imgs/articles/' . $industry['img'])); ?>"
                style="border-top-left-radius: 10px; border-top-right-radius: 10px; width: 100%;" alt="">
            <div class="p-3">
                <h4 class="text-center p-2 fw-bold"><?php echo e($industry['title']); ?></h4>

                <?php if(!empty($industry['company'])): ?>
                    <h5 class="p-2">Company profile:</h5>
                    <p class="p-2">
                        <strong><?php echo e($industry['company']); ?></strong> <?php echo e($industry['description']); ?>

                    </p>
                <?php else: ?>
                    <p class="p-2"><?php echo e($industry['description']); ?></p>
                <?php endif; ?>

                <?php if(!empty($industry['wide'])): ?>
                    <div class="row">
                        <div class="col-md-6">
                            <h5 class="p-2">Technical Stream</h5>
                            <ul>
                                <?php $__currentLoopData = $industry['streams']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stream): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li><?php echo e($stream); ?></li>
                        ...
                        <div class="col-md-6">
                            ...
                            <ul>
                                <?php $__currentLoopData = $industry['majors']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $major): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li><?php echo e($major); ?></li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </ul>
                        </div>
                    </div>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="row mt-5 pt-5" id="canapplay">
            <div class="col-md-5 text-center pt-5">
                <img src="<?php echo e(asset('assets/imgs/who can applay.png')); ?>" class="p-5" style="max-width: 350px; " alt="Image">
            </div>
...
<div class="row" id="register">
  <div class="col-12 responsive-banner" style="height: 380px;
      background-image: url('<?php echo e(asset('assets/imgs/Baneer2.png')); ?>');
      background-size: cover;
      background-position: center center;
      background-repeat: no-repeat;">
  </div>
        ...
        <div class="row pt-5">
            <div class="col-md-4 text-center pt-5">
                ...
                <img src="<?php echo e(asset('assets/imgs/logoss/10 (1).jpg')); ?>" class="img-fluid" style="max-height: 200px" alt="">
            </div>
            ...
            <div class="col-md-4 text-center">
                ...
                <img src="<?php echo e(asset('assets/imgs/logoss/9 (1).jpg')); ?>" class="img-fluid" style="max-height: 200px" alt="">
            </div>
            <div class="col-md-8 pt-5">
                <div class="text-center">
                    <!--<a href="<?php echo e(route('register.index')); ?>" class="btn btn-primary" id="applyButton">Apply Now</a>-->
                    <br><br>
...
.separator {
    background-image: url('<?php echo e(asset("assets/img/selection.jpg")); ?>');
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/zhufapmy/public_html/internships/internshipPortal/resources/views/welcome.blade.php ENDPATH**/ ?>