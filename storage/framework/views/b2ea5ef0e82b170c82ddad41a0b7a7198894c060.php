    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <table class="table table-striped table-bordered" style="max-height: 800px; overflow-y: auto;">
                ...
                <tbody> 
                    <?php $__currentLoopData = $all_student_feedbacks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $all_feedback): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><?php echo e($all_feedback->intern_full_name); ?></td>
                            <td><?php echo e($all_feedback->mobile_number); ?></td>
                            <td><?php echo e($all_feedback -> supervisor_full_name); ?></td>
                            <td><?php echo e($all_feedback -> orientation_sufficient); ?></td>
                            
                            <td><?php echo e($all_feedback -> supervisor_available); ?></td>
                            <td><?php echo e($all_feedback -> challenging_internship); ?></td>
                            <td><?php echo e($all_feedback -> practical_skills); ?></td>
                            <td><?php echo e($all_feedback -> positive_work_environment); ?></td>
                            <td><?php echo e($all_feedback -> build_network); ?></td>
                            <td><?php echo e($all_feedback -> recommend_internship); ?></td>
                            
                            <td><?php echo e($all_feedback -> comments); ?></td>
...
<?php echo $__env->make('layouts.adminlayouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/zhufapmy/public_html/internships/internshipPortal/resources/views/studentuserfeedbacks.blade.php ENDPATH**/ ?>