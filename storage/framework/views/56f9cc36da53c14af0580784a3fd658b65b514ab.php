<?php $__env->startSection('content'); ?>
  <div class="container">
      ...
      <div class="col-md-10">
        <div class="card">
          <div class="card-header">
            <h1 class="text-center"><?php echo e(__('Assigned Students')); ?></h1>
    ...
    <tbody>
        ...
        <tr>
            <td><?php echo e($row['round']); ?></td>
            <td><?php echo e($row['intern_full_name']); ?></td>
            <td><?php echo e($row['intern_email']); ?></td>
            <td><?php echo e($row['user_name']); ?></td>
            <td><?php echo e($row['user_email']); ?></td>
            <td><?php echo e($row['user_industry']); ?></td>
            <td><?php echo e($row['training_field']); ?></td>
            <td>
                <button class="btn btn-danger remove-intern-btn" data-intern-id="<?php echo e($row['intern_id']); ?>">Remove</button>
            </td>
        </tr>
...
<?php echo $__env->make('layouts.adminlayouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/zhufapmy/public_html/internships/internshipPortal/resources/views/assignedstudents.blade.php ENDPATH**/ ?>