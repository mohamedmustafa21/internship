    ...
    <div class="row">
      ...
      <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block sidebar collapse">
        <div class="position-sticky pt-3">
          <div class="logo">
            <img src="<?php echo e(asset('assets/img/logo-1.png')); ?>" alt="Logo" height="40" class="d-inline-block align-middle me-2">
          </div>
          <ul class="nav flex-column">
              <li class="nav-item">
                  <a class="nav-link active" aria-current="page" href="<?php echo e(route('hrdashboard')); ?>">
              ...
              <!-- supervisors.all -->
              <li class="nav-item">
                  <a class="nav-link active" aria-current="page" href="<?php echo e(route('supervisors.all')); ?>">
                    <span data-feather="home"></span>
                    Mentors & HR Dashboard
                  </a>
              </li>
            <li class="nav-item">
              <a class="nav-link" href="<?php echo e(route('assignpage')); ?>">
                <span data-feather="file"></span>
                Assign Students
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="<?php echo e(route('assignedview')); ?>">
                <span data-feather="file"></span>
                Assigned Students
              </a>
            </li>
            ...
            <li class="nav-item">
              <a class="nav-link modal-selector" href="<?php echo e(route('mentorfeedbacks.all')); ?>" data-toggle="modal" data-target="#addSupervisorModal">
                  <span data-feather="shopping-cart"></span>
            ...
            <!-- /hr/studentfeedbacks -->
            <li class="nav-item">
              <a class="nav-link modal-selector" href="<?php echo e(route('studentfeedbacks.all')); ?>" data-toggle="modal" data-target="#addSupervisorModal">
                  <span data-feather="shopping-cart"></span>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form method="POST" action="<?php echo e(route('supervisors.store')); ?>">
                  <?php echo csrf_field(); ?>
                ...
                <div class="form-group" id="training_field_assign_id" style="display:none;">
                      <label for="training_field_assign"><?php echo e(__('Training Field')); ?></label>
...
<?php /**PATH /home4/zhufapmy/public_html/internships/internshipPortal/resources/views/layouts/adminlayouts.blade.php ENDPATH**/ ?>