            ...
            <table class="table table-striped table-bordered">
                ...
                <tbody> 
                    <?php $__currentLoopData = $supervisors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supervisor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><?php echo e($supervisor->id); ?></td>
                            <td><?php echo e($supervisor->name); ?></td>
                            <td><?php echo e($supervisor->email); ?></td>
                            <td><?php echo e($supervisor->industry); ?></td>
                            <td><?php echo e($supervisor -> type); ?></td>
                            <td><?php echo e($supervisor -> training_field); ?></td>
                            <td>
                                <button class="btn btn-danger remove-intern-btn" data-supervisor-id="<?php echo e($supervisor->id); ?>">Remove</button>
                            </td>
                        </tr>
...
<?php echo $__env->make('layouts.adminlayouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/zhufapmy/public_html/internships/internshipPortal/resources/views/allSupervisors.blade.php ENDPATH**/ ?>