                        ...
                        <table class="table table-striped table-bordered" style="max-height: 800px; overflow-y: auto;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ asset('assets/'.$student->student_id_card) }}">File uploaded</a></td>
                                    ...
                                    <td>{{ $student->email }}</td>
                                    <td>{{ $student->training_10th_of_Ramadan == 'I Agree' ? 'I Agree Training in 10th of Ramadan' : 'Don\'t Agree'}}</td>
                                    <td>{{ $student->training_ain_sokhna == 'I Agree' ? 'I Agree Training in 10th of Ramadan' : 'Don\'t Agree'}}</td>
