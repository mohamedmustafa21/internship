...
class CreateStudentToProgramFeedbacksTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('student_to_program_feedbacks', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('student_to_program_feedbacks');
    }
}
